...
public class Room_TypeVO implements java.io.Serializable {
	...
	public void setRoom_type_sale_status(Integer room_type_sale_status) {
	...
	public String toString() {
		return "Room_TypeVO =[room_type_id=" + room_type_id + " room_type_name=" + room_type_name + "room_type_amount="
				+ room_type_amount + "room_type_content=" + room_type_content + "room_type_sale_status="
				+ room_type_sale_status + "room_total_review=" + room_total_review + "room_type_pic=" + room_type_pic
