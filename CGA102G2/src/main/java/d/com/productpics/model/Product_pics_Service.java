...
public class Product_pics_Service {
	...
	public Product_pics_VO addOneProductPics(Integer procuct_id, byte[] product_photo) {
		// (Integer product_category_id, String product_category_name, String
		// product_category_describtion) {
...
//		product_picsVO.setProduct_category_detail(product_category_describtion);		
	...
	public List<Product_pics_VO> getAllPicsbyId(Integer product_id){
		return dao.getAllbyId(product_id);
	}
