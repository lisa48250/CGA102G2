...
//	}
	...
	// 模糊比對
	public List<Product_VO> getProdByLikeName(String product_name) {
		return dao.findByLikeProductName(product_name);
	}
	
	public List<Product_VO> getProductByCategoryId(Integer product_category_id) {
		
		return dao.getAllProductsCateGoryId(product_category_id);
	}

	public List<Product_VO> getPriceFromLowToHigh(){
		return dao.getPriceLtoH();
	}
	
	public List<Product_VO> getPriceFromHightToLow(){
		return dao.getPriceHtoL();
	}
}
