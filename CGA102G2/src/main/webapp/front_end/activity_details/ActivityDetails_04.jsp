...
<%@ include file="/front_end/frontpage/IncludeHeader.jsp" %>
	...
	<main>
		<div class="maindiv">
			<div class="div1">
				<img class="head-img" src="<%=request.getContextPath()%>/images/04藺草技藝首頁.jpg">
				<div class="slide-down" style=" position: absolute; left: 400px;">
					<p>藺草技藝體驗</p>
				</div>
			</div>
	...
	<FORM id="form"
				...
				<div class="sticky">
					...
					<input type="hidden" name="action" value="insert_1"> <input
						type="hidden" name="activityID" value="4"> <input
		...
		<div class="div5">
			...
			<p class="p10">&nbsp; &nbsp;
				&nbsp;學習藺草產業的歷史、文化知識，把親手做的可愛藺草小馬書籤帶回家！</p>
			<img class="img1" src="<%=request.getContextPath()%>/images/activity4.jpg">
