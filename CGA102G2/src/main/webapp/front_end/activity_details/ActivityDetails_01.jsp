...
<%@ include file="/front_end/frontpage/IncludeHeader.jsp" %>
	...
	<main>
		<div class="maindiv">
			<div class="div1">
				<img class="head-img" src="<%=request.getContextPath()%>/images/茶道首頁.jpg">
	...
	<FORM id="form"
		...
		<div class="div5">
			...
			<p class="p10">&nbsp; &nbsp;
				&nbsp;日本茶道是為客人奉茶之事，是一種茶敍的儀式，日本人稱之為「茶湯」，和其他東亞茶儀式一樣，都是一種以品茶為主而發展出來的特殊文化。現代的茶道，由主人準備茶與點心（和菓子）招待客人，而主人與客人都按照固定的規矩與步驟行事。</p>
			<img class="img1" src="<%=request.getContextPath()%>/images/activity1.jpg">
		

			<hr class="phr">
			<p class="p11">課程內容</p>
			<p class="p11-1" style=" position: absolute; top: 645px;">
				1.茶室的禮儀：進入茶室的方法。<br> 2.茶會的空間佈置介紹。 <br>3.正統日本茶道裏千家「盆略點前」演示。
				<br>4.正確享用抹茶與伴茶干菓子的方法。 <br>5.刷一碗茶實作。 <br>6.茶室中歡聚的一期一會，留下永恆留念的照片。
			</p>
	
			<div class="div7">
				<p class="p12">
					<span>活動資訊：</span><br>
					<br>1.活動報名時間為6/1~7/17。
					<br>2.進入茶室，需穿著白襪，如未穿著白襪者，可現場購買台灣白棉襪一雙20元。 <br>3.本活動在榻榻米房間進行，請穿著適合散盤或跪坐之衣著，避免太短的裙裝。
					<br>4.本活動僅供7歲以上貴賓報名參加(7歲以下兒童可陪同父母，但無法參與活動)，7歲~13歲兒童需成人陪同才可參加活動。
				</p>
			</div>
		</div>
		</div>
