...
Integer room_type_id = (Integer) request.getAttribute("room_type_id2"); // 取得room_type的id為2的物件
...
<body onload="connect();" onunload="disconnect();">
	...
	<main>
		...
		<form action="${pageContext.request.contextPath}/room_type.do"
			...
			<input type="hidden" name="room_type_id2" value="${room_type_id }">
			<input type="hidden" name="action2" value="立即訂房">
		</form>
		...
		<img id="photo"
			src="${pageContext.request.contextPath}/images/四人房1-1.png">
