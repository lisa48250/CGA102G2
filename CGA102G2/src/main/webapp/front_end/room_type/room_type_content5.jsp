...
Integer room_type_id = (Integer) request.getAttribute("room_type_id"); // 取得room_type的id為1的物件
...
%>
<%--     <jsp:useBean  id="room_type_photoSvc"  scope="page" class="com.room_type_photo.model.Room_type_photoService"/> --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body onload="connect();" onunload="disconnect();">
	...
	<main>
		...
		<form action="${pageContext.request.contextPath}/room_type.do"
			...
			<input type="hidden" name="room_type_id1" value="${room_type_id }">
			<input type="hidden" name="action1" value="立即訂房">
		</form>
		...
		<img id="photo"
			src="${pageContext.request.contextPath}/Room_Type_Reader?id=${ room_typeVO.room_type_id}">
