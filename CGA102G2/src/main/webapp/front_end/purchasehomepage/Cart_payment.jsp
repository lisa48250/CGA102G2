...
<%@ include file="/front_end/frontpage/IncludeHeader.jsp" %>
  ...
  <main class="detail_list">
   ...
   <div id="Allphoto">
    ...
    <div class="info">
    <form action="${pageContext.request.contextPath}/Product_order_detailServlet" id="formmm">
					...
					<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
						<div class="accordion-body">
							<div class="info-1">
								...
								<table class="car_table2"  width="550" style="font-size:20px;">
	...
	<%
     Integer amounts= 0;
		...
		/* List<Product_VO> poVOList = new ArrayList<Product_VO>(); */
...
// 		 Product_VO prod = new Product_VO();
	...
	%>
									<tr>
										<%-- <td width="100"><div align="center"><b><%=index+1 %></b></div></td> --%>
										
										<td width="20"><div align="center"><b style="color:orange;"><%=order.getProduct_name()%></b></div></td>
<%-- 		<td width="100"><div align="center"><b><%=order.getName()%></b></div></td> --%>
										<td width="20"><div align="center"><b>$<%=order.getProduct_price()%></b></div></td>
<%-- 		<td width="100"><div align="center"><b><%=order.getPrice()%></b></div></td> --%>
										<td width="20"><div align="center"><b><%=order.getProduct_quantity()%></b></div></td>
										</tr>
										<%}%>
<%-- 	<%}%> --%>
</table>				
						<b style="position:relative; right:230px; top:220px;">會員編號: <%=request.getAttribute("memberID")%></b>
						<div class="show_amounts">
						<span style="border-bottom:1px solid black; font-size:35px;">購物車總金額</span><span style="border-bottom:1px solid black; font-size:35px;"><b style="font-size:30px">  總數量: <%=nums%></span>
						<div>總計：<span style="positon:relative; left: 400px;">＄<%=amounts%></span>
						</div>
						...
						<div class="accordion-body">
							...
							<div class="container">
								...
								<div class="cah">
									...
									<input type="submit" name = "action" value="送出訂單" class="submit-top" >
...
<!-- 									<input type="hidden" name="action" value="來自購物車信用卡付款"> -->
