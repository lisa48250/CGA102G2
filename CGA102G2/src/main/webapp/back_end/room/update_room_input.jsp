...
<!-- ==================* 主畫面區 *================== -->
<main>
<div id = "tableall" style="height:450px">
			...
			<td>
				...
				<h4>
					<a
						...
						src="${pageContext.request.contextPath}/images/home.png" width="50" height="50" border="0"></a></h4>
			</td>
		</tr>
	</table>
<br>
	...
	<FORM METHOD="post"
		...
		<table id="table-2" style="margin-left: 47px">
			<tr>
				<td>房間編號:<font color=red><b>*</b></font></td>
				<td id="roomtypeid"><%=roomVO.getRoom_id()%></td>
			</tr>
			...
			<%-- <tr>
		<td>房型編號:</td>
		<td><input type="TEXT" name="room_type_id" size="45" value="<%=roomVO.getRoom_id()%>" /></td>
	</tr> --%>
			...
			<%-- <tr>
				...
				<td><input type="TEXT" name="room_guest_name" size="45"
					value="<%=roomVO.getRoom_guest_name()%>" /></td>
			</tr> --%>
			<tr>
				<td>上下架狀態:<font color=red><b>*</b></font></td>
				<td><select size="1" name="room_sale_status">
						<option value="0" ${(roomVO.room_sale_status==0) ? 'selected' : ''}>上架</option>
						<option value="1" ${(roomVO.room_sale_status==1) ? 'selected' : ''}>下架</option>
				</select></td>
			</tr>
			<tr>
				...
				<td><select size="1" name="room_status">
						...
						<option value="2" ${(roomVO.room_status==2) ? 'selected' : ''}>未入住</option>
				</select></td>
			</tr>
		</table>
		<br> <input type="hidden" name="action" value="update"> 
		<input
			type="hidden" name="room_id" value="<%=roomVO.getRoom_id()%>">
