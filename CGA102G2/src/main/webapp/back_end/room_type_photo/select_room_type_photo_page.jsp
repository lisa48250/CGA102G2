...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/select_room_type_photo_page.css">
<title>房型圖片管理</title>
...
<!--                 </li> -->
 ...
 <main>
    <div id = "tableall">
<table id="table-1">
   <tr><td><h3>房型圖片管理</h3></td></tr>
</table>

<!-- <p>This is the Home page for Room_Type_Photo: Home</p> -->
...
<ul>
  <li class=selectall><a  href='${pageContext.request.contextPath}/back_end/room_type_photo/listAllRoom_Type_Photo.jsp'>查詢所有圖片</a>  <br><br></li>
<br>
<%-- <li>
    <FORM METHOD="post" ACTION="${pageContext.request.contextPath}/Room_Type_PhotoServlet" >
        <b>輸入照片編號 (如1):</b>
        <input type="text" name="room_type_photo_id" value="${param.room_type_photo_id}"><font color=red></font>
  ...
  <li>
     <FORM METHOD="post" ACTION="${pageContext.request.contextPath}/Room_Type_PhotoServlet" >
       ...
       <input type="hidden" name="action" value="getOne_For_DisplayPH">
...
<br>
<ul>
  <li class=addroomtype><a href='addRoom_Type_Photo.jsp'>新增房型照片</a></li>
</ul>
</div>
</main>
</body>
