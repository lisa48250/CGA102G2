...
<!-- 					</ul></li> -->
	...
	<!-- ==================* 主畫面區 *================== -->
	<main>
		<div id="tableall" style="height:600px">
	<table id="table-1">
		<tr>
			<td>
				<h3>房型照片資料</h3>
	...
	<table id="table-2">
		...
		<tr>
		    <td>${list.room_type_photo_id}</td>
			<td>${list.room_type_id}</td>
			<td><img  id= "room-img"
				src="<%=request.getContextPath()%>/Room_Type_Photo_Reader?id=${list.room_type_photo_id}"></td>
		</tr>
		</c:forEach>	
	</table>
	</div>
