...
<!-- 					</ul></li> -->
	...
	<h1 class="p">最新消息查詢</h1>
		<div class="right-1">
			<a
				href="${pageContext.request.contextPath}/back_end/news/NewsBackInsert.jsp"><span class="span-1">新增最新消息</span></a>
			<span class="span-2">/</span> <a
				href="${pageContext.request.contextPath}/back_end/news/NewsBackUpdate.jsp"><span class="span-3">修改最新消息</span></a>
		</div>
		<div class="control">
