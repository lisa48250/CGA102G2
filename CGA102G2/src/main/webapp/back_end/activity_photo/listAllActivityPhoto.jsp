...
<%
	...
	List<ActivityPhotoVO> list = activityPhotoService.getAll();
	pageContext.setAttribute("list",list);
	Integer activity_photo_ID = (Integer) request.getAttribute("activity_photo_ID");
%>
...
<!--                     </li> -->
        ...
        <main class="main">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h4 class="h4">活動圖片管理-所有活動圖片資料</h4>
                    </div>
                </div>
                <div class="row justify-content-between">
                    <div class="col-md-auto">
                        <a href="${pageContext.request.contextPath}/back_end/activity_photo/addActivityPhoto.jsp">
                            <button type="button" class="btn btn-secondary"><i class="fa-solid fa-plus"></i>新增活動圖片</button>
                        </a>
                    </div>
                    <div class="col-md-auto">
                        ...
                        <table id="table_id" class="table table-striped table-hover ">
                            <thead class="thead thead-dark">
                                <tr style="white-space:nowrap">
                                    <th scope="col" style="text-align: center">活動圖片編號</th>
                                    <th scope="col" style="text-align: center">活動名稱</th>
                                    <th scope="col" style="text-align: center">活動圖片</th>
...
<%-- 								<c:forEach var="activityPhotoVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>"> --%>
								<c:forEach var="activityPhotoVO" items="${list}">
                                <tr class="text-center" ${(activityPhotoVO.activity_photo_ID == param.activity_photo_ID) ? 'bgcolor=#CCCCFF':''}>
                                    <td>${activityPhotoVO.activity_photo_ID}</td>
									<td>${activityPhotoVO.activityVO.activity_name}</td>
									<td>
                                    ...
                                    <td>
                                        <div class="editgroup">
                                            <form method="post" action="${pageContext.request.contextPath}/activity_photo/ActivityPhotoServlet.do">
                                                <button class="btn btn-primary" type="submit" value="修改"><i class="fa-regular fa-pen-to-square"></i></button>
                                                <input type="hidden" name="activity_photo_ID"  value="${activityPhotoVO.activity_photo_ID}">
