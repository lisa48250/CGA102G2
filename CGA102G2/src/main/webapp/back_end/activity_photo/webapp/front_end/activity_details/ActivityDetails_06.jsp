...
<%@ include file="/front_end/frontpage/IncludeHeader.jsp" %>
	...
	<main>
		<div class="maindiv">
			<div class="div1">
				<img class="head-img" src="<%=request.getContextPath()%>/images/06巧克力首頁.jpg">
				<div class="slide-down" style="    position: absolute; left: 150px;">
					<p>七夕情人節巧克力製作體驗</p>
				</div>
			</div>
	...
	<FORM id="form"
				...
				<div class="sticky">
					...
					<input type="hidden" name="action" value="insert_1"> <input
						type="hidden" name="activityID" value="6"> <input
		...
		<div class="div5">
			<div class="div6">
				...
				<p class="p7">七夕情人節巧克力製作體驗</p>
				<p class="p8">活動期間:</p>
				<p class="p9">2022/08/01 ~ 2022/08/31</p>
				<hr class="div1hr">
			</div>
			<p class="p10">&nbsp; &nbsp;
				&nbsp;七夕節由星宿崇拜衍化而來，為中國傳統意義上的七姐誕，因拜祭「七姐」活動在七月七晩上舉行，故名「七夕」。經歷史發展，七夕被賦予了「牛郎織女」的美麗愛情傳說，使其成為了象徵愛情的節日，從而被認為是中國最具浪漫色彩的傳統節日。</p>
			<img class="img1" src="<%=request.getContextPath()%>/images/activity6.jpg">
