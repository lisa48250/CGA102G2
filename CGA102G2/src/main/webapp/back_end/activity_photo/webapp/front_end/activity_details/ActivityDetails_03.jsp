...
<%@ include file="/front_end/frontpage/IncludeHeader.jsp" %>
	...
	<main>
		<div class="maindiv">
			<div class="div1">
				<img class="head-img" src="<%=request.getContextPath()%>/images/03雅美族搗小米首頁.jpg">
				<div class="slide-down" style="    position: absolute; left: 220px;">
					<p>雅美族搗小米生活體驗</p>
				</div>
			</div>
	...
	<FORM id="form"
				...
				<div class="sticky">
					...
					<input type="hidden" name="action" value="insert_1"> <input
						type="hidden" name="activityID" value="3"> <input
						type="hidden" name="activitySessionDate" id="activitySessionDate">
		</div>
	</FORM>
		...
		<div class="div5">
			<div class="div6">
				...
				<p class="p7">雅美族搗小米生活體驗</p>
				<p class="p8">活動期間:</p>
				<p class="p9">2022/07/01 ~ 2022/07/31</p>
				<hr class="div1hr">
			</div>
			<p class="p10">&nbsp; &nbsp;
				&nbsp;在雅美族收穫祭中，晚上家家戶戶大多會團聚共餐，餐後則有搗小米(meyvaci)的活動。召集搗小米的人會帶著一根木杵，最先由五、六個老人開始，按照年齡成隊繞臼而行，每人輪流上前舂粟。臼中小米舂爛後，會不時有人帶來新的小米加入臼中，此過程中並伴隨著祈求的歌聲，藉由歌聲和搗小米的儀式，為部落祈求來年的大豐收。</p>
			<img class="img1" src="<%=request.getContextPath()%>/images/activity3.jpg">
		

			<hr class="phr">
			<p class="p11">課程內容</p>
			<p class="p11-1" style="position: absolute; top: 648px;">
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.將小米脫殼。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6.將蒸好的小米放入臼中。 
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.用米胎將殼和榖粒分開。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  7.搗小米。
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.將小米泡水。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8.用線將麻糬取下。
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.將小米蒸熟。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9.享用小米麻糬。
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.在臼裡抹油。 
...
/* 		document.getElementById('connect').disabled = false;
	...
	<script>
	let minDate; 
	let maxDate = new Date(2022, 6, 31);
	debugger;
	if(new Date().getTime() < new Date(2022, 5, 17).getTime()){
