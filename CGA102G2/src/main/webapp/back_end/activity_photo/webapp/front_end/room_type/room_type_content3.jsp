...
Integer room_type_id = (Integer) request.getAttribute("room_type_id3"); // 取得room_type的id為3的物件
...
<body onload="connect();" onunload="disconnect();">
	...
	<main>
		...
		<form action="${pageContext.request.contextPath}/room_type.do"
			...
			<input type="hidden" name="room_type_id3" value="${room_type_id }">
			<input type="hidden" name="action3" value="立即訂房">
		</form>
