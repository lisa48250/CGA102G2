...
<%@ include file="/front_end/frontpage/IncludeHeader.jsp" %>
	...
	<main>
		<div class="maindiv">
			<div class="div1">
				<img class="head-img" src="<%=request.getContextPath()%>/images/05父親節皮革首頁.jpg">
				<div class="slide-down" style="    position: absolute; left: 210px;">
					<p>父親節皮革禮物製作體驗</p>
				</div>
			</div>
	...
	<FORM id="form"
				...
				<div class="sticky">
					...
					<input type="hidden" name="action" value="insert_1"> <input
						type="hidden" name="activityID" value="5"> <input
		...
		<div class="div5">
			<div class="div6">
				...
				<p class="p7">父親節皮革禮物製作體驗</p>
				<p class="p8">活動期間:</p>
				<p class="p9">2022/07/01 ~ 2022/07/31</p>
				<hr class="div1hr">
			</div>
			<p class="p10">&nbsp; &nbsp;
				&nbsp;父親節是一個為感謝父親而慶祝的節日，世界各地因不同的歷史、文化原因選在不同日期。父親們在這一天裡通常會收到孩子們送的禮物。其中以6月的第三個星期日為父親節的國家與地區最多，包括歐亞及美洲的超過80個國家或地區。</p>
			<img class="img1" src="<%=request.getContextPath()%>/images/activity5.jpg">
		

			<hr class="phr">
			<p class="p11">課程內容</p>
			<p class="p11-1" style=" top: 650px;">
				<br>1.選擇禮物樣式。 
				<br>2.皮革打版裁縫切割。 
				<br>3.完成禮物。 
				<br>4.活動紀念留影。
