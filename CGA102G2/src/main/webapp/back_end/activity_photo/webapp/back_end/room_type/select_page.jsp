...
<ul>
  <li class=selectall><a  href='${pageContext.request.contextPath}/back_end/room_type/listAllRoom_Type.jsp'>查詢所有房型</a>  <br><br></li>
    <br>
  <b>單項搜尋：</b>
  
  <li>
    <FORM METHOD="post" ACTION="${pageContext.request.contextPath}/room_type.do" >
        <b>輸入房型編號 (如1):</b>
        <input type="text" name="room_type_id" value="${param.room_type_id}">
  ...
  <li>
     <FORM METHOD="post" ACTION="${pageContext.request.contextPath}/room_type.do" >
       ...
       <select size="1" name="room_type_id">
         <c:forEach var="room_typeVO" items="${room_typeSvc.all}" > 
          <option value="${room_typeVO.room_type_id}">${room_typeVO.room_type_name}
         </c:forEach>   
       </select>
       <input type="hidden" name="action" value="getOne_For_Display">
       <input type="submit" value="送出">
  ...
  <%-- <li>
     <FORM METHOD="post" ACTION="room_type.do" >
       ...
       <select size="1" name="room_type_id">
         <c:forEach var="room_typeVO" items="${room_typeSvc.all}" > 
          <option value="${room_typeVO.room_type_id}">${room_typeVO.room_type_sale_status}
         </c:forEach>   
       </select>
       <input type="hidden" name="action" value="getOne_For_Display">
       <input type="submit" value="送出">
...
<br>
<ul>
  <li class=addroomtype><a href='${pageContext.request.contextPath}/back_end/room_type/addRoom_Type.jsp'>新增房型</a></li>
</ul>
</div>
</main>
