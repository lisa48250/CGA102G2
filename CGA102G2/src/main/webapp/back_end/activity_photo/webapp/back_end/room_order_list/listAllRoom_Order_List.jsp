...
List<Room_order_listVO> list = room_order_listSvc.getAll();
...
<!--                 </li> -->
	...
	<div id="tableall2" style="width: 936px;" >

<table id="table-1" style="width: 936px;">
	<tr><td>
		 <h3>所有訂單明細資料</h3>
		 <h4><a href="${pageContext.request.contextPath}/back_end/room_order_list/listAllRoom_Order_List.jsp"><img src="${pageContext.request.contextPath}/images/home.png"
							width="50" height="50" border="0"></a></h4>
	</td></tr>
</table>

<table id="table-2" cellspacing="0" style="width: 936px;  margin-bottom: 0px;">
	<tr id="tr-1">
		<th>明細編號</th>
		<th>訂單編號</th>
		<th>房型名稱</th>
	...
	<%@ include file="page1.file" %> 
	 <c:forEach var="Room_order_listVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		
		<tr>
			<td>${Room_order_listVO.room_order_list_id}</td>
			<td>${Room_order_listVO.room_order_id}</td>
			<td>${Room_order_listVO.roomTypeVO.room_type_name}</td>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/RoomOrderListServlet" style="margin-bottom: 0px;">
			     ...
			     <input type="hidden" name="room_order_list_id"  value="${Room_order_listVO.room_order_list_id}">
