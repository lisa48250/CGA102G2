...
<%@ page import="com.authority_function.model.*"%>
...
<%
Authority_FunctionVO authority_functionVO = (Authority_FunctionVO) request.getAttribute("authority_functionVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
...
<a class="all" style="cursor:pointer;" href="${pageContext.request.contextPath}/back_end/emp/AllEmployee.jsp">返回所有員工</a>
	...
	<tr>
		<td>${authority_functionVO.function_id}</td> 
 		<th>${authority_functionVO.function_name}</th>
