...
List<Product_order_detailVO> podVOlist1 = (List<Product_order_detailVO>)request.getAttribute("podVOlist1");
	...
	pageContext.setAttribute("podVOlist1", podVOlist1);
%>
<!DOCTYPE html>
<html lang="en">
...
<div class="errorMsg">
	...
	<div id="tableall2">
		...
		<h1 >購物訂單</h1>
			...
			<c:forEach var="eachOrderListVO" items="${podVOlist1}" 
				varStatus="d">
				<tr>
