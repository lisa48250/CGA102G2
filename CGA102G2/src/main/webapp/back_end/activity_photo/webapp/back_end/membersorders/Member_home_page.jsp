...
<main id="main">
	<div class="search-form">
					...
					<%-- <FORM METHOD="post"
						ACTION="${pageContext.request.contextPath}/Product_order_detailServlet">
						<input style="cursor:pointer;" class="newest" type="submit" value="查詢昨天訂單">
						<input type="hidden" name="action" value="yesterday-order">
					</FORM>
					<FORM METHOD="post"
						ACTION="${pageContext.request.contextPath}/Product_order_detailServlet">
						<input style="cursor:pointer;" class="newest" type="submit" value="查詢7天前訂單">
						<input type="hidden" name="action" value="7days-order">
					</FORM> --%>
	...
	<div id="tableall2">
		...
		<h1 >購物訂單</h1>
			...
			<c:forEach var="eachOrderListVO" items="${podVOlist}" 
				varStatus="d">
				<tr id="sortable">
					<td class="ui-state-default">${eachOrderListVO.product_order_id}</td>
					<td class="ui-state-default">${eachOrderListVO.member_id}</td>
					<td class="ui-state-default"><fmt:formatDate
							value="${eachOrderListVO.product_order_date}"
							pattern="yyyy-MM-dd" /></td>
					<td class="ui-state-default"> ${eachOrderListVO.getProduct_amount()}</td>
