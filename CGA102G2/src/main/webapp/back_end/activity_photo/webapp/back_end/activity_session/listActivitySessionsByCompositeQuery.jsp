...
<jsp:useBean id="listActivitySessionsByCompositeQuery" scope="request" type="java.util.List<ActivitySessionVO>" /> <!-- 於EL此行可省略 -->
...
<!--                     </li> -->
                    ...
                    <li>
                        ...
                        <ul id="list">
                            ...
                            <li>
                            	<a href='${pageContext.request.contextPath}/back_end/activity_photo/listAllActivityPhoto.jsp'>活動圖片管理</a>
                            </li>
                            <li>
...
<!--                     </li> -->
        ...
        <main class="main">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h4 class="h4">活動場次管理-活動場次複合查詢</h4>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <table class="table table-striped table-hover ">
                            ...
                            <tbody class="">
								...
								<c:forEach var="activitySessionVO" items="${listActivitySessionsByCompositeQuery}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
                                <tr class="text-center" ${(activitySessionVO.activity_session_ID==param.activity_session_ID) ? 'bgcolor=#CCCCFF':''}>
									...
									<td>
										<c:forEach var="activityVO" items="${activityService.all}">
						                    <c:if test="${activitySessionVO.activity_ID==activityVO.activity_ID}">
