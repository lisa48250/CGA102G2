...
<jsp:useBean id="listActivitiesByCompositeQuery" scope="request" type="java.util.List<ActivityVO>" /> <!-- 於EL此行可省略 -->
...
<!--                     </li> -->
        ...
        <main class="main">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h4 class="h4">活動項目管理-活動項目複合查詢</h4>
                    </div>
                </div>
                <div class="row justify-content-between">
                    <div class="col-md-auto">
                        <a href="${pageContext.request.contextPath}/back_end/activity/addActivity.jsp">
                            <button type="button" class="btn btn-secondary"><i class="fa-solid fa-plus"></i>新增活動項目</button>
                        </a>
                    </div>
                    <div class="col-md-auto">
                    ...
                    <div class="col">
                        <table class="table table-striped table-hover ">
                            ...
                            <tbody class="">
								...
								<c:forEach var="activityVO" items="${listActivitiesByCompositeQuery}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
                                <tr class="text-center"   ${(activityVO.activity_ID == param.activity_ID) ? 'bgcolor=#CCCCFF':''}>
									...
									<td>
										<c:forEach var="activityCategoryVO" items="${activityCategoryService.all}">
						                    <c:if test="${activityVO.activity_category_ID==activityCategoryVO.activity_category_ID}">
