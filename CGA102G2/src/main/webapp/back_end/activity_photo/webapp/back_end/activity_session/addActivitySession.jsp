...
<%-- 				</c:if> --%>
                ...
                <div class="addblock border border-light bg-light rounded">                
                    ...
                    <form method="post"
                        action="${pageContext.request.contextPath}/activity_session/ActivitySessionServlet.do" name="form1" onsubmit="this.activity_state.disabled=false">
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="dateNew" id="activity_session_start" class="form-control" id="selectActivitySessionStart"
                                        placeholder="請選擇場次開始日期時間" name="activity_session_start" onkeydown="return false"
                                        value="${param.activity_session_start}">                                    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="dateNew" id="activity_session_end" class="form-control" id="selectActivitySessionEnd"
                                        placeholder="請選擇場次結束日期時間" name="activity_session_end" onkeydown="return false"
                                        value="${param.activity_session_end}">                                    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                	...
                                	<select size="1" name="activity_enroll_state" class="form-control" id="selectEnrollState" disabled>
										<option value="0" selected>未開放報名</option>
										<option value="1">接受報名</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <textarea name="editor1" class="form-control" id="inputStateNote">${param.status_note}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="number" class="form-control" id="insertMaxPart"
                                        ...
                                        value="${param.activity_max_part == null ? 0 : param.activity_max_part}">                                    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="number" class="form-control" id="insertMinPart"
                                        ...
                                        value="${param.activity_min_part == null ? 0 : param.activity_min_part}">                                    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="number" class="form-control" id="enroll"
                                        name="enroll_total" 
                                        value="${param.enroll_total == null ? 0 : param.enroll_total}" readonly>                                    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="dateNew" id="enroll_start" class="form-control" id="selectEnrollStart"
                                        placeholder="請選擇報名開始日期" name="enroll_start" onkeydown="return false"
                                        value="${param.enroll_start}">                                    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="dateNew" id="enroll_end" class="form-control" id="selectEnrollEnd"
                                        placeholder="請選擇報名結束日期" name="enroll_end" onkeydown="return false"
                                        value="${param.enroll_end}">                                    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                	...
                                	<select size="1" name="activity_session_state" class="form-control" id="selectActivitySessionState" disabled>
