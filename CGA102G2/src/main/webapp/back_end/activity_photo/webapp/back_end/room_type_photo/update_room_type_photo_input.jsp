...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/update_room_type_photo_input.css">
<title>房型照片修改 - update_room_type_photo_input.jsp</title>
</head>
<!-- ==================* 後台框架區 *================== -->
...
<FORM METHOD="post" ACTION="${pageContext.request.contextPath}/Room_Type_PhotoServlet" id="form1" enctype="multipart/form-data">
<table id="table-2">
	<tr>
		<td>房型圖片編號:<font color=red><b>*</b></font></td>
		<td id="roomtypeid"><%=room_type_photoVO.getRoom_type_photo_id()%></td>
	</tr>
	...
	<jsp:useBean id="room_typeSvc" scope="page"
		...
		<td><input class="up" type="file" name="room_type_photo" size="45" accept="image/*" value="<%=room_type_photoVO.getRoom_type_photo()%>/Room_Type_Photo_Reader"/>
		<img class="room_img" name="room_type_photo" src="${pageContext.request.contextPath}/Room_Type_Photo_Reader?id=${room_type_photoVO.room_type_photo_id}" style="height:80px; width:160px; left: 450px; bottom: 0px;  position: absolute; "></td>
	</tr>
	
	</table>
<br>
<input type="hidden" name="action" value="update">
<input type="hidden" name="room_type_photo_id" value="<%=room_type_photoVO.getRoom_type_photo_id()%>">
