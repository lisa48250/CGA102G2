...
<%
	//ActivityPhotoServlet.java (Concroller) 存入req的activityPhotoVO物件 (包括幫忙取出的activityPhotoVO, 也包括輸入資料錯誤時的activityPhotoVO物件)
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="activityPhotoID">活動圖片編號：</label>
                                    <input type="text" class="form-control col-sm-1" id="activityPhotoID"
                                        placeholder="${activityPhotoVO.activity_photo_ID}"
                                        value="${activityPhotoVO.activity_photo_ID}"
                                        name="activity_photo_ID" readonly>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group form">
                                    ...
                                    <select size="1" name="activity_ID" class="form-control" id="selectActivity">
										<c:forEach var="activityVO" items="${activityService.all}">
											<option value="${activityVO.activity_ID}" ${(activityPhotoVO.activity_ID == activityVO.activity_ID)? 'selected':'' } >${activityVO.activity_name}
										</c:forEach>
									</select>
                                </div>
                            </div>
