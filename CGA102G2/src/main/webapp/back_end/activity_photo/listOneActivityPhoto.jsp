...
<%
	//ActivityPhotoServlet.java(Concroller), 存入req的activityPhotoVO物件
...
<!--                     </li> -->
        ...
        <main class="main">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h4 class="h4">活動圖片管理-單一活動圖片資料</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <table class="table table-striped table-hover ">
                            ...
                            <tbody class="" ${(activityPhotoVO.activity_photo_ID == param.activity_photo_ID) ? 'bgcolor=#CCCCFF':''}>
