...
<!--                     </li> -->
        ...
        <main class="main">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h4 class="h4">活動類別管理-單一活動類別資料</h4>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-hover ">
                            <thead class="thead thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">類別資訊</th>
                                    <th scope="col">編輯</th>
                                </tr>
                            </thead>
                            <tbody class="" ${(activityVO.activity_category_ID == param.activity_category_ID) ? 'bgcolor=#CCCCFF':''}>
                                <tr class="text-center">
                                    <td><%=activityCategoryVO.getActivity_category_ID()%></td>
                                    <td><%=activityCategoryVO.getActivity_category_name()%></td>
                                    <td><%=activityCategoryVO.getActivity_category_info()%></td>
                                    <td>
                                        <div class="editgroup">
