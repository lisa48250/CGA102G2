                        ...
                        <div class="col">
                            <form method="post"
                                ...
                                <div class="form-group form-inline">
                                    <label for="inputActivityCategoryID">輸入活動類別編號：</label>
                                    <input type="text" class="form-control" id="inputActivityCategoryID"
                                        placeholder="請輸入數字" name="activity_category_ID">
                    ...
                    <div class="row">
                        <div class="col">
                            <form method="post"
                                action="<%=request.getContextPath()%>/activity_category/ActivityCategoryServlet.do">
                                <div class="form-group form-inline">
                                    <label for="selectActivityCategoryID">選擇活動類別編號：</label>
                                    <select size="1" class="form-control" name="activity_category_ID"
                                        id="selectActivityCategoryID">
                                        <c:forEach var="activityCategoryVO" items="${activityCategoryService.all}">
                                            <option value="${activityCategoryVO.activity_category_ID}">
                                                ${activityCategoryVO.activity_category_ID}
                                        </c:forEach>
                                    </select>
                                    <input type="hidden" name="action" value="getOneForDisplay">
                                    <input type="submit" class="btn btn-dark" value="送出">
                    ...
                    <div class="row">
                        <div class="col">
                            <form method="post"
                                action="<%=request.getContextPath()%>/activity_category/ActivityCategoryServlet.do">
                                <div class="form-group form-inline">
                                    <label for="selectActivityCategoryName">選擇活動類別名稱：</label>
                                    <select size="1" class="form-control" name="activity_category_ID"
                                        id="selectActivityCategoryName">
                                        <c:forEach var="activityCategoryVO" items="${activityCategoryService.all}">
                                            <option value="${activityCategoryVO.activity_category_ID}">
                                                ${activityCategoryVO.activity_category_name}
                                        </c:forEach>
                                    </select>
                                    <input type="hidden" name="action" value="getOneForDisplay">
                                    <input type="submit" class="btn btn-dark" value="送出">
