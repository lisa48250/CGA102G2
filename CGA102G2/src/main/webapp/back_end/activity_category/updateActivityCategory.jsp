...
<%
	//ActivityCategoryServlet.java(Concroller), 存入req的activityCategoryVO物件
                ...
                <div class="addblock border border-light bg-light rounded">
                    ...
                    <form method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="activityCategoryID">活動類別編號：</label>
                                    <input type="text" class="form-control col-sm-1" id="activityCategoryID"
                                        placeholder="<%=activityCategoryVO.getActivity_category_ID()%>"
                                        name="activity_category_id" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="inputActivityCategoryID">活動類別名稱：</label>
                                    <input type="text" class="form-control" id="inputActivityCategoryID"
                                        name="activity_category_name"
                                        value="<%=activityCategoryVO.getActivity_category_name()%>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="inputActivityCategoryName">活動類別資訊：</label>
                                    <textarea name="editor1" class="form-control" id="inputActivityCategoryName"><%=activityCategoryVO.getActivity_category_info()%></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="hidden" name="activity_category_ID"
                                        value="<%=activityCategoryVO.getActivity_category_ID()%>">
<!--                                     <input type="submit" class="btn btn-dark" value="送出修改"> -->
