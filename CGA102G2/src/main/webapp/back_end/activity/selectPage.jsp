        ...
        <main class="main">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <h4 class="h4">活動項目管理-活動項目查詢</h4>
                    </div>
                </div>
                <div class="row justify-content-end">
                    <div class="col-md-auto">
                       <a href="<%=request.getContextPath()%>/back_end/activity/listAllActivity.jsp">
                        ...
                        <div class="col">
                            <form method="post"
                                ...
                                <div class="form-group form-inline">
                                    <label for="inputActivityID">輸入活動編號：</label>
                                    <input type="text" class="form-control" id="inputActivityID"
                                        placeholder="請輸入數字" name="activity_ID">
                                    <input type="hidden" name="action" value="getOneForDisplay">
                                    <input type="submit" class="btn btn-dark" value="送出">
                                    <div><font color=red>${errorMsgs.activity_ID}</font></div>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <form method="post"
                                action="<%=request.getContextPath()%>/activity/ActivityServlet.do">
                                <div class="form-group form-inline">
                                    <label for="selectActivityID">選擇活動編號：</label>
