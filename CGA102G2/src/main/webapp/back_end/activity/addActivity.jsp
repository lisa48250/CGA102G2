...
<%-- 				</c:if> --%>
                ...
                <div class="addblock border border-light bg-light rounded">                
                    ...
                    <form method="post"
                        action="${pageContext.request.contextPath}/activity/ActivityServlet.do" name="form1" onsubmit="this.activity_state.disabled=false">
                                ...
                                <div class="form-group form">
                                    ...
                                    <select size="1" name="activity_category_ID" class="form-control" id="selectActivityCategory">
										<c:forEach var="activityCategoryVO" items="${activityCategoryService.all}">
											<option value="${activityCategoryVO.activity_category_ID}" ${(param.activity_category_ID == activityCategoryVO.activity_category_ID)? 'selected':'' } >${activityCategoryVO.activity_category_name}
										</c:forEach>
									</select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="insertActivityName">活動名稱：</label><div><font color=red>${errorMsgs.activity_name}</font></div>
                                    <input type="text" class="form-control" id="insertActivityName"
                                        placeholder="請輸入活動名稱" name="activity_name" 
                                        value="${param.activity_name}">                                    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="number" class="form-control" id="insertActivityPrice"
                                        placeholder="請輸入活動價格" name="activity_price" 
                                        value="${param.activity_price == null ? 0 : param.activity_price}">                                    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="dateNew" id="f_date1" class="form-control" id="selectActivityStart"
                                        placeholder="請選擇活動開始日期" name="activity_start" onkeydown="return false" autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <input type="dateNew" id="f_date2" class="form-control" id="selectActivityEnd"
                                        placeholder="請選擇活動結束日期" name="activity_end" onkeydown="return false" autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <textarea name="editor1" class="form-control" id="inputActivityDescription">${activityVO.activity_description}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <textarea name="editor2" class="form-control" id="inputActivityContent">${activityVO.activity_content}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    ...
                                    <textarea name="editor3" class="form-control" id="inputActivityInfo">${activityVO.activity_info}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                	...
                                	<select size="1" name="activity_state" class="form-control" id="selectActivityState" disabled>
