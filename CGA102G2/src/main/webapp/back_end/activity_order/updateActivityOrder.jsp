                ...
                <div class="addblock border border-light bg-light rounded">
                    ...
                    <form method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="activityName">活動：</label>
                                    <input type="text" class="form-control col-sm-3" id="activityName"
                                        placeholder="${activityJoinVO.activityName}"
                                        value="${activityJoinVO.activityName}"
                                        name="activityName" readonly>                                        
                                </div>
                            </div>
                        </div>                         
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="activitySession">活動場次編號：</label>
...
<!-- 									</select> -->
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="activitySessionStart">場次開始時間：</label>
									<input type="text" class="form-control col-sm-3" id="activitySessionStart"
                                        placeholder="${activityJoinVO.activitySessionStart}"
                                        value="${activityJoinVO.activitySessionStart}"
                                        name="activitySessionStart" readonly>   
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form">
                                    <label for="activitySessionEnd">場次結束時間：</label>
									<input type="text" class="form-control col-sm-3" id="activitySessionEnd"
                                        placeholder="${activityJoinVO.activitySessionEnd}"
                                        value="${activityJoinVO.activitySessionEnd}"
                                        name="activitySessionEnd" readonly>   
