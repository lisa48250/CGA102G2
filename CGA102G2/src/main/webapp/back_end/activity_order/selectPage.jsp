				...
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/activityJoin/activityJoin.do" name="form1">
	                <div class="addblock border border-light bg-light rounded">
	                	<div class="form-group">
							<b><font color=blue><i class="fa-solid fa-star"></i>複合查詢<i class="fa-solid fa-star"></i></font></b>
<!-- 							<b><font color=blue><i class="fa-solid fa-star"></i>一對多查詢<i class="fa-solid fa-star"></i></font></b> -->
	                	</div>
	                
	                
<!-- 	                本來想做複合查詢，但不知道為什麼除了會員以外都會找失敗，猜測是變數名問題 -->
<!-- 		                <div class="form-group form-inline">							         -->
<!-- 					        <label for="selectActivityOrderID2">選擇活動訂單編號：</label> -->
<!-- 							<select size="1" name="activityOrderId" id="selectActivityOrderID2" class="form-control"> -->
<!-- 									<option value=""> -->
<%-- 								<c:forEach var="activityJoinVO" items="${activityJoinService.all}" >  --%>
<%-- 									<option value="${activityJoinVO.activityOrderId}">${activityJoinVO.activityOrderId} --%>
<%-- 								</c:forEach>    --%>
<!-- 							</select> -->
<!-- 						</div> -->
						...
						<div class="form-group form-inline">
					        <label for="selectMember">選擇會員：</label>
					        <select size="1" name="member_id" id="selectMember" class="form-control">
					           <option value="">
...
<!-- 		                <div class="form-group form-inline">							         -->
<!-- 					        <label for="selectActivitySessionID2">選擇活動場次編號：</label> -->
<!-- 							<select size="1" name="activitySessionID" id="selectActivitySessionID2" class="form-control"> -->
<!-- 									<option value=""> -->
...
<!-- 						    <select size="1" name="refundState" id="selectRefundState" class="form-control"> -->
<!-- 						    	<option value=""> -->
...
<!-- 		                </div> -->
						<div class="form-group form-inline">
					        <input type="hidden" name="action" value="listActivityOrdersByCompositeQuery">
					        <input type="submit" class="btn btn-dark" value="送出">
		                </div>
