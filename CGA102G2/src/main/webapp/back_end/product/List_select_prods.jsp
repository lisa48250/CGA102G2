...
<a href="<%=request.getContextPath() %>/back_end/product/Select_page.jsp"><h1>回商品管理首頁</h1></a>
<%-- <a href="<%=request.getContextPath() %>/back_end/product/Select_page.jsp"><img src="<%=request.getContextPath() %>/images/logo.png" width="100" height="32" border="0"><h1>回首頁</h1></a> --%>
...
<table>
	...
	<tr>
		<td>${prodVO.product_id}</td>
		<td>${prodVO.product_name}</td>
		
		<td>${prodVO.product_category_name}</td>
		<td>${prodVO.product_describtion}</td>
		<td>${prodVO.product_price}</td>
		
		<td>${prodVO.product_quantity}</td>
