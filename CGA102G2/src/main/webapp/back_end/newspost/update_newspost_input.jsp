		...
		<div class="body">
			<FORM id="addform" METHOD="post"
				...
				<table class="addnewspost">
					...
					<div class="date">
						報導日期: <input  autocomplete="off" name="newsPostDate" id="f_date1" type="text"
							placeholder="請輸入媒體日期"
					...
					<div class="editor1">
						...
						<textarea name="editor1" id="editor1" cols="50" rows="10"><%=(newspostVO == null) ? "" : newspostVO.getContent()%></textarea>
						<script>
